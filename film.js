...
const detailFilmu = filmy.find((item) => item.id === identifikator);

const detailFilmuContent = document.querySelector('#detail-filmu');
...
const hodnoceni = (number) => {
  hvezdaElements.forEach((hvezda, index) => {
